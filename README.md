...
The HCL AppScan DAST Github Action enables you to run dynamic analysis security testing (DAST) against your application. The DAST scan identifies security vulnerabilities in your code and stores the results in AppScan on Cloud or AppScan 360°.
...
In the event of a user cancelling an action workflow midway through a DAST scan, this action will also automatically cancel the same scan in AppScan on Cloud or AppScan 360°, thereby freeing up your scan queues. 
...
## 3. Auto embed of GITHUB SHA in AppScan reports
The Github SHA associated to the action will be embedded in AppScan in the following locations:
